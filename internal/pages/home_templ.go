...
func featureCardImage(alt, imagePath string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.ResolveAttributeValue(alt)
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.ResolveAttributeValue(public.AssetURL(imagePath))
		if templ_7745c5c3_Err != nil {
...
func emailFormInner(errorMessage string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 20, "<div id=\"email-form\" class=\"flex w-full flex-col items-center\"><form class=\"flex w-full justify-center\" data-on:submit=\"@post('/subscribe', {contentType: 'form'})\" data-indicator:submitting><div class=\"join join-vertical w-full max-w-md sm:join-horizontal sm:w-auto\"><input id=\"waitlist-email\" class=\"input input-lg join-item w-full sm:w-75\" name=\"email\" type=\"email\" placeholder=\"Your email address...\" required data-attr:disabled=\"$submitting\"> <button class=\"btn btn-lg btn-primary join-item w-full sm:w-auto\" data-attr:disabled=\"$submitting\"><span data-show=\"$submitting\" style=\"display: none\" class=\"loading loading-spinner loading-sm\"></span> Submit</button></div></form>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if errorMessage != "" {
